...
@combine_report_bp.route('/combine_report_page',methods=['POST'])
def get_pdf_file():
    ...
    page_01_path=f'./db/imgs/page_01_{randint(0,99999999999999)}.png'
    page_02_path=f'./db/imgs/page_02_{randint(0,99999999999999)}.png'
